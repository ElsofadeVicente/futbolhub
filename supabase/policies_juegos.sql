...
alter table cinco_de_cinco_companeros              enable row level security;
alter table cinco_de_cinco_entrenadores            enable row level security;
alter table cinco_de_cinco_ganadores_clubes_intl   enable row level security;
alter table cinco_de_cinco_ganadores_seleccion     enable row level security;
alter table cinco_de_cinco_ganadores_liga_copa     enable row level security;
alter table cinco_de_cinco_premios_individuales    enable row level security;
...
create policy "public read" on cinco_de_cinco_companeros            for select using (true);
create policy "public read" on cinco_de_cinco_entrenadores          for select using (true);
create policy "public read" on cinco_de_cinco_ganadores_clubes_intl for select using (true);
create policy "public read" on cinco_de_cinco_ganadores_seleccion   for select using (true);
create policy "public read" on cinco_de_cinco_ganadores_liga_copa   for select using (true);
create policy "public read" on cinco_de_cinco_premios_individuales  for select using (true);
