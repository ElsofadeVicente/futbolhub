...
drop table if exists cinco_de_cinco_companeros;
drop table if exists cinco_de_cinco_entrenadores;
drop table if exists cinco_de_cinco_ganadores_clubes_intl;
drop table if exists cinco_de_cinco_ganadores_seleccion;
drop table if exists cinco_de_cinco_ganadores_liga_copa;
drop table if exists cinco_de_cinco_premios_individuales;
